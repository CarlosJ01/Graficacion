...
void pasosCabezaMorado(Cadena,Cadena,Cadena, char);
void pasosCabezaNaranja(Cadena,Cadena,Cadena, char);
void pasosCabezaVerde(Cadena,Cadena,Cadena, char);

void pasosColaMorado(Cadena,Cadena,Cadena, char);
void pasosColaNaranja(Cadena,Cadena,Cadena, char);
void pasosColaVerde(Cadena,Cadena,Cadena, char);
...
int main(){
	...
	pasosCabezaVerde(cadenas[0], cadenas[1], cadenas[2], '^');
	pasosCabezaVerde(cadenas[0], cadenas[1], cadenas[2], 'v');
	pasosCabezaVerde(cadenas[0], cadenas[1], cadenas[2], '<');
	pasosCabezaVerde(cadenas[0], cadenas[1], cadenas[2], '>');
...
void pasosCabezaVerde(Cadena mora, Cadena nara, Cadena verd, char opc){
	...
	if(libre(cbz)){
		...
		pasosCabezaNaranja(cadenas[0], cadenas[1], cadenas[2], '^');
		pasosCabezaNaranja(cadenas[0], cadenas[1], cadenas[2], 'v');
		pasosCabezaNaranja(cadenas[0], cadenas[1], cadenas[2], '<');
		pasosCabezaNaranja(cadenas[0], cadenas[1], cadenas[2], '>');
	}
}

void pasosCabezaNaranja(Cadena mora, Cadena nara, Cadena verd, char opc){
	...
	if(libre(cbz)){
		...
		pasosCabezaMorado(cadenas[0], cadenas[1], cadenas[2], '^');
		pasosCabezaMorado(cadenas[0], cadenas[1], cadenas[2], 'v');
		pasosCabezaMorado(cadenas[0], cadenas[1], cadenas[2], '<');
		pasosCabezaMorado(cadenas[0], cadenas[1], cadenas[2], '>');
	}
}

void pasosCabezaMorado(Cadena mora, Cadena nara, Cadena verd, char opc){
	...
	if(libre(cbz)){
		...
		pasosColaMorado(cadenas[0], cadenas[1], cadenas[2], '^');
		pasosColaMorado(cadenas[0], cadenas[1], cadenas[2], 'v');
		pasosColaMorado(cadenas[0], cadenas[1], cadenas[2], '<');
		pasosColaMorado(cadenas[0], cadenas[1], cadenas[2], '>');
	}
}

void pasosColaMorado(Cadena mora, Cadena nara, Cadena verd, char opc){
	...
	if(libre(cla)){
		...
		pasosColaNaranja(cadenas[0], cadenas[1], cadenas[2], '^');
		pasosColaNaranja(cadenas[0], cadenas[1], cadenas[2], 'v');
		pasosColaNaranja(cadenas[0], cadenas[1], cadenas[2], '<');
		pasosColaNaranja(cadenas[0], cadenas[1], cadenas[2], '>');
	}
}

void pasosColaNaranja(Cadena mora, Cadena nara, Cadena verd, char opc){
	...
	if(libre(cla)){
		...
		pasosColaVerde(cadenas[0], cadenas[1], cadenas[2], '^');
		pasosColaVerde(cadenas[0], cadenas[1], cadenas[2], 'v');
		pasosColaVerde(cadenas[0], cadenas[1], cadenas[2], '<');
		pasosColaVerde(cadenas[0], cadenas[1], cadenas[2], '>');
	}
}

void pasosColaVerde(Cadena mora, Cadena nara, Cadena verd, char opc){
